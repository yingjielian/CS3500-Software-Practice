...
namespace DependencyGraphTestCases
{
    ...
    public class DependencyGraphTestCases
    {
        ...
        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void NullTest06()
        {
            DependencyGraph t = new DependencyGraph();
            string s = null;
            string r = "a";
            t.RemoveDependency(s, r);
        }

        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void NullTest07()
        {
            DependencyGraph t = new DependencyGraph();
            string s = null;
            t.ReplaceDependees(s, new HashSet<string>() { "x", "y", "z" });
        }

        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void NullTest08()
        {
            DependencyGraph t = new DependencyGraph();
            string s = null;
            t.ReplaceDependents(s, new HashSet<string>() { "x", "y", "z" });
        }
