...
namespace Formulas
{
    ...
    public class GradingTests
    {
        ...
        public void Test60()
        {
            Formula f = new Formula("y*3-8/2");
            Assert.AreEqual(8, (double)f.Evaluate(s => (s == "x") ? 1 : 4), 1e-9);
        }
        ...
        public void Test61()
        {
            Formula f = new Formula("4*(8-9*2)/14*x");
            Assert.AreEqual(-2.85714285714, (double)f.Evaluate(s => (s == "x") ? 1 : 4), 1e-9);
        }
